				...
				<div className='panel-body'>
					<form className='form-horizontal' role='form'>
						<div className='form-group'>
							<label htmlFor='input_transcriptome' className='col-sm-3 control-label'>Transcriptome: </label>
						...
						<hr />
						<div className='form-group'>
							<label htmlFor='input_n_features' className='col-sm-3 control-label'>Number of features: </label>
							<div className='col-sm-9'>
								<input type='number'
						...
						<div className='form-group'>
							<label htmlFor='input_cluster_method' className='col-sm-3 control-label'>Clustering Method: </label>
							<div className='col-sm-9'>
								<Select
						...
						<div className='form-group' style={{
							...
							<label htmlFor='input_submit_create_dataset' className='col-sm-7 control-label'>
